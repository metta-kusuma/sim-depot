<?php
$user_id_saat_ini = $_SESSION['id_plng'];
$username_saat_ini = $_SESSION['nama_plng'];
...
<div class='col-12'>
    ...
    <div class="form-section">
        ...
        <div class="user-info mb-4">
            <p><strong>Nama:</strong> <?php echo htmlspecialchars($username_saat_ini); ?></p>
        ...
        <form method="POST" action="./data.php?menu=<?php echo $menuParam; ?>&act=update_password" id="form-ubah-password">
             <input type="hidden" name="id_plng" value="<?php echo $user_id_saat_ini; ?>">
