        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <span id="loading-status" class="nav-link loading">
                    <i class="fas fa-sync-alt fa-spin"></i> <span class="status-text"> Memuat...</span>
                </span>
            </li>
            </ul>
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                <a class="nav-link" data-toggle="dropdown" href="#">
                    ...
                    <span class="d-none d-sm-inline-block">&nbsp;<?= htmlspecialchars($_SESSION['user_login'] ?? 'Pengguna') ?></span>
                </a>
        ...
        <div class="sidebar">
            <nav class="mt-2">
                ...
                ?>
                    ...
                    <li class="nav-item">
                        <a href="index.php?menu=member" class="nav-link <?php echo ($menu == 'member') ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-users"></i><p>Data Pelanggan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="index.php?menu=pemesanan" class="nav-link <?php echo ($menu == 'pemesanan') ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-shopping-cart"></i><p>Pesanan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                ?>
                    ...
                    <li class="nav-item <?php echo $isKualitasOpen ? 'menu-open' : ''; ?>">
                        <a href="#" class="nav-link <?php echo $isKualitasOpen ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-tint"></i><p>Kualitas Air <i class="fas fa-angle-left right"></i></p>
                        </a>
                        <ul class="nav nav-treeview">
                            <li class="nav-item"><a href="index.php?menu=aktivitasdata" class="nav-link <?php echo ($menu == 'aktivitasdata') ? 'active' : ''; ?>"><i class="far fa-circle nav-icon"></i><p>Cek Kualitas Air</p></a></li>
                            <li class="nav-item"><a href="index.php?menu=arsip_dinkes" class="nav-link <?php echo ($menu == 'arsip_dinkes') ? 'active' : ''; ?>"><i class="far fa-circle nav-icon"></i><p>Laporan Dinkes</p></a></li>
                        </ul>
                    </li>
                <?php
                }
                ...
                ?>
                    <li class="nav-item">
                        <a href="index.php?menu=pengantaran_anggota" class="nav-link <?php echo ($menu == 'pengantaran_anggota' || $menu == '') ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-truck"></i><p>Pengantaran Tersedia</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="index.php?menu=pengantaran_saya" class="nav-link <?php echo ($menu == 'pengantaran_saya') ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-map-marked-alt"></i><p>Pengantaran Saya</p>
                        </a>
                    </li>
                     <?php
                }
                ...
                ?>
                    ...
                    <li class="nav-item">
                        <a href="index.php?menu=kelola_user" class="nav-link <?php echo ($menu == 'kelola_user') ? 'active' : ''; ?>">
                    ...
                    <li class="nav-item">
                        <a href="index.php?menu=pengaturan_admin" class="nav-link <?php echo ($menu == 'pengaturan_admin') ? 'active' : ''; ?>">
                            <i class="nav-icon fas fa-cogs"></i><p>Pengaturan Admin</p>
                        </a>
                    </li>
                    <?php
                }
    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-fluid pt-3"> <?php
                ...
                // Halaman Kasir
                elseif ($menu == 'dashboard' && $level_lowercase == 'kasir') { $file_to_include = "data/dashboard.php"; }
                elseif ($menu == 'produk' && $level_lowercase == 'kasir') { $file_to_include = "data/produk.php"; }
                elseif ($menu == 'member' && $level_lowercase == 'kasir') { $file_to_include = "data/member.php"; }
                elseif ($menu == 'pemesanan' && $level_lowercase == 'kasir') { $file_to_include = "data/pemesanan.php"; }
                // Halaman Pimpinan
                elseif ($menu == 'aktivitasdata' && $level_lowercase == 'pimpinan') { $file_to_include = "data/aktivitasfilter.php"; }
                elseif ($menu == 'arsip_dinkes' && $level_lowercase == 'pimpinan') { $file_to_include = "laporan/arsip_dinkes.php"; }
                elseif ($menu == 'laporan' && $level_lowercase == 'pimpinan') { $file_to_include = "laporan/laporan.php"; }
                // Halaman Anggota
                elseif ($menu == 'pengantaran_anggota' && $level_lowercase == 'anggota') { $file_to_include = "data/pengantaran_anggota.php"; }
                elseif ($menu == 'pengantaran_saya' && $level_lowercase == 'anggota') { $file_to_include = "data/pengantaran_saya.php"; }
                // elseif ($menu == 'lacak_kurir' && $level_lowercase == 'anggota') { $file_to_include = "../lacak_kurir.php"; }
