 ...
 switch($_GET[act])
{
 ...
 <span class=title2><B>PEMBAYARAN PESANAN</b></span>
 </form><form action=?menu=pembayaran method=POST>
 Kode Pesan<input type=text name=kd_pesan size=30 value='$_POST[kd_pesan]' autocomplete=off>
 ...
 <table width=100% STYLE=BORDER-COLLAPSE:COLLAPSE; border=0 bgcolor=#333333>
		...
		echo "
		 ...
		 <td>$ket
		 <td> 
 	      <a href=\"./data.php?menu=pembayaran&act=update&kd_pesan=$r[no_order]\"onClick=\"return confirm('Update Pembayaran (&nbsp;&nbsp;Kode Pemesanan :$r[no_order]&nbsp;&nbsp;) ?')\"><center>Update</a>  
